...
const COUNTRIES = [
  ...
  { code: "OC", name: "Rest of Europe (residual)", currency: "EUR", pppRate: 1.00 },
  ...
  { code: "OH", name: "Rest of N. America (residual)", currency: "USD", pppRate: 1.10 },
  // Latin America
  ...
  { code: "OD", name: "Rest of developing (residual)", currency: "USD", pppRate: 1.10 },
  ...
  { code: "QM", name: "Qatar & Gulf (residual)", currency: "USD", pppRate: 1.10 },
  { code: "OE", name: "Rest of Middle East (residual)", currency: "USD", pppRate: 1.10 },
  // Sub-Saharan Africa
  ...
  { code: "OJ", name: "Rest of Sub-Saharan Africa (residual)", currency: "USD", pppRate: 1.10 },
  // Russia & Central Asia
  ...
  { code: "OA", name: "Rest of Asia (residual)", currency: "USD", pppRate: 1.10 },
  // East Asia
  ...
  { code: "OB", name: "Rest of East Asia (residual)", currency: "USD", pppRate: 1.10 },
  ...
  { code: "OI", name: "Rest of S. Asia (residual)", currency: "USD", pppRate: 1.10 },
  // World
  { code: "World", name: "World (aggregate)", currency: "EUR", pppRate: 1.00 },
];
